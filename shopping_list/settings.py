...
CSRF_TRUSTED_ORIGINS = ['http://dimas-herjunodarpito-tutorial.pbp.cs.ui.ac.id', 
                        'https://dimas-herjunodarpito-tutorial.pbp.cs.ui.ac.id']

# Quick-start development settings - unsuitable for production
# See https://docs.djangoproject.com/en/4.2/howto/deployment/checklist/

# SECURITY WARNING: keep the secret key used in production secret!
SECRET_KEY = "django-insecure-e1g7-xavu6)8@exv04n%lq+4fy20l0ke*0t)k-y_4es56-asv6"
